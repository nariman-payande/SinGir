...
<b>]] .. tostring(links)..[[</b>
  سازنده : @ghool]]
				...
				elseif (text:match("^(آماده)$") and not msg.forward_info_)then
					return tdcli_function({
						ID = "ForwardMessages",
						chat_id_ = msg.chat_id_,
						from_chat_id_ = msg.chat_id_,
